...
ActiveRecord::Schema.define(version: 2021_01_26_030353) do
  ...
  create_table "dtags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "tag_drafts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
